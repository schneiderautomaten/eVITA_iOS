...
- (NSString *)uniqueId {
    return [[NSString alloc] initWithFormat:@"eVITA-cloud-file-%d-%lld-%d-%lld", _datacenterId, _volumeId, _localId, _secret];
}
...
- (NSString *)uniqueId {
    return [[NSString alloc] initWithFormat:@"eVITA-cloud-document-%lld", _fileId];
}
