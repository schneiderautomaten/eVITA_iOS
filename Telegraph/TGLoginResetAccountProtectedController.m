...
- (void)logOut {
    ...
    [TGAppDelegateInstance saveLoginStateWithDate:stateDate phoneNumber:_phoneNumber phoneCode:nil phoneCodeHash:nil codeSentToeVITA:false codeSentViaPhone:false firstName:nil lastName:nil photo:nil resetAccountState:nil];
    
    [TGAppDelegateInstance presentLoginController:true animated:true phoneNumber:_phoneNumber phoneCode:nil phoneCodeHash:nil codeSentToeVITA:false codeSentViaPhone:false profileFirstName:nil profileLastName:nil resetAccountState:nil];
}
